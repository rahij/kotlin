...
class FirImplicitTypeBodyResolveProcessor(state: State) : FirTransformerBasedResolveProcessor(state) {
    override val transformer = FirImplicitTypeBodyResolveTransformerAdapter(state.scopeSession)
}

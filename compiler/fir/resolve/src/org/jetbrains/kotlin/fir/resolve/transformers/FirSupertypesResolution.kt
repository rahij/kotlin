...
class FirSupertypeResolverProcessor(state: State) : FirTransformerBasedResolveProcessor(state) {
    override val transformer = FirSupertypeResolverTransformer(state.scopeSession)
}

...
class FirContractResolveProcessor(state: State) : FirTransformerBasedResolveProcessor(state) {
    override val transformer = FirContractResolveTransformerAdapter(state.scopeSession)
}
